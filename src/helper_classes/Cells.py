...
from src.helper_classes.BodyParams import *
...
class RectangleCells(AbstractAngle):
    ...
    def calculation(self):
        ...
        self.s_cells = self.v_cells / self.cell_height  # sqare size of all cells
        self.s_cell = self.s_cells / (self.rows * self.columns)  # sqare size of 1 cell
